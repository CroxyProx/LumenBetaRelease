...
class MainWindow(QMainWindow):
    ...
    def show_loading(self):
        self.loading_label.setGeometry(0, 0, self.width(), self.height())  # Dynamically adjust size
        self.loading_label.show()
        self.movie.start()

    def hide_loading(self):
        QTimer.singleShot(500, lambda: self.loading_label.hide())  # Adds a small delay to make it visible
        self.movie.stop()
